...
#### Pivots 
In the RetinaLiteClassifier.ipynb, we have it tested against other subproblems and classifiers again to see how they compare. We also reformatted the problem as Healthy vs Not Healthy and understood how the model did in that case, too.
